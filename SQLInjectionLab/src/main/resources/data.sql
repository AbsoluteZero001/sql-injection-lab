...
INSERT INTO users (username, password, email, status, role, description) VALUES ('test', '$2a$10$/g/GJktYHgZvVE5bXmFqj..6Rcmjv35OCdzvo3NwwIkV2rqsUy4gm', 'test@example.com', 'active', 'user', 'Test user account');
INSERT INTO users (username, password, email, status, role, description) VALUES ('guest', '$2a$10$OVlvscbMLznNLQj7sIdM/utRaU7RqGGUVtH6bVRpHtuxgNjzUE6x.', 'guest@example.com', 'inactive', 'user', 'Guest user account');
INSERT INTO users (username, password, email, status, role, description) VALUES ('admin''--', '$2a$10$pzbCR9fN79HyL9IVxgbnoemqIMx31AMs7ozWyqGsjWfHZLPJ115Li', 'hack@example.com', 'active', 'user', 'Test account for SQL injection');
